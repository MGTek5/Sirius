  ...
  const formik = useFormik ({
    ...
    onSubmit: async values => {
      try {
        ...
        console.log (error);
        toast.error (
          'Something went wrong while signing into your account. Please check your credentials...'
        );
      }
    },
  });
  ...
  return (
    <main className="flex flex-col justify-center items-center">
      <div className="card lg:card-side bordered">
        <figure>
          <img
            src="https://source.unsplash.com/yZygONrUBe8"
            alt="earth with a satellite"
          />
        </figure>
        <div className="card-body">
        <img src="/icons/icon-512x512.png" className="h-12 w-12 md:h-24 md:w-24 lg:h-32 lg:w-32 self-center" />
          <h2 className="card-title text-xl font-bold text-center">Welcome back to Sirius</h2>
